...
public class Main {
	...
	private void solve() {
		...
		int N_div = sc.nextInt();
		int N_pattern = sc.nextInt();
		int sigma = sc.nextInt();
		double p_event = sc.nextDouble();
		int delta_event = sc.nextInt();
		for (int i = 0; i < N_pattern; i++) {
			for (int j = 0; j < N_div; j++) {
				int pw = sc.nextInt();
			}
		}
		int N_grid = sc.nextInt();
		int C_grid_init = sc.nextInt();
		int C_grid_max = sc.nextInt();
		int V_grid_max = sc.nextInt();
		for (int i = 0; i < N_grid; i++) {
			int x = sc.nextInt();
			int pattern = sc.nextInt();
		}
		int N_ev = sc.nextInt();
		int C_ev_init = sc.nextInt();
		int C_ev_max = sc.nextInt();
		int V_ev_max = sc.nextInt();
		int N_trans_max = sc.nextInt();
		int delta_ev_move = sc.nextInt();
		for (int i = 0; i < N_ev; i++) {
			int pos = sc.nextInt();
		}
		double p_const_trans = sc.nextDouble();
		int T_last = sc.nextInt();
		int P_trans = sc.nextInt();
		double gamma = sc.nextDouble();
		int S_ref_ele = sc.nextInt();
		int S_ref_trans = sc.nextInt();
		int T_max = sc.nextInt();
		for (int i_sol = 0; i_sol < N_solution; i_sol++) {
			for (int t = 0; t < T_max; t++) {
				for (int i = 0; i < N_grid; i++) {
					int x = sc.nextInt();
					int y = sc.nextInt();
					int pw_actual = sc.nextInt();
					int pw_excess = sc.nextInt();
					int pw_buy = sc.nextInt();
				}
				for (int i = 0; i < N_ev; i++) {
					int charge = sc.nextInt();
					int u = sc.nextInt();
					int v = sc.nextInt();
					int dist_from_u = sc.nextInt();
					int dist_from_v = sc.nextInt();
			...
			double S_trans = sc.nextDouble();
			double S_ele = sc.nextDouble();
		}
	}
