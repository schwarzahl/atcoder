...
public class Main {
	...
	private void solve() {
		...
		for (int i = 0; i < L; i++) {
			String tmp = fusion(a, b, i);
			if (tmp != null) {
				abs.add(tmp);
			}
			if (i > 0) {
				String tmp2 = fusion(a, b, -i);
				if (tmp2 != null) {
					abs.add(tmp2);
				}
			}
		...
		long ans = 10000L;
		for (String ab : abs) {
			if (ans < Math.max(ab.length(), c.length())) {
				break;
			}
			for (int i = -ab.length(); i <= c.length(); i++) {
				String tmp = fusion(ab, c, i);
				if (tmp != null) {
	...
	String fusion(String a, String b, int diff) {
		String buffer = "????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????";
		StringBuilder sb = new StringBuilder();
		for (int a_index = 0; a_index < a.length(); a_index++) {
			int b_index = a_index + diff;
			if (b_index < 0 || b.length() <= b_index ) {
				continue;
			}
			char ac = a.charAt(a_index);
			char bc = b.charAt(b_index);
			if (ac == '?') {
				sb.append(bc);
			} else if (bc == '?' || ac == bc) {
				sb.append(ac);
		...
		if (diff >= b.length()) {
			return b + buffer.substring(0, diff - b.length()) + a;
		}
		if (diff > 0) {
			return b.substring(0, diff) + sb.toString() + a.substring(diff);
		}
		if (-diff >= a.length()) {
			return a + buffer.substring(0, -diff - a.length()) + b;
		}
		return a.substring(0, -diff) + sb.toString() + b.substring(-diff);
	}
